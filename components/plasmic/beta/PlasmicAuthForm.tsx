...
// Plasmic Project: b5CyNdwUApgg3rPkmHo66E
// Component: MlNXg0SiMhWq
...
import projectcss from "./plasmic_beta.module.css"; // plasmic-import: b5CyNdwUApgg3rPkmHo66E/projectcss
import sty from "./PlasmicAuthForm.module.css"; // plasmic-import: MlNXg0SiMhWq/css
...
function PlasmicAuthForm__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__hnuo8, {
          [sty.freeBoxmode_checkEmail__hnuo8HSqEm]: hasVariant(
            $state,
            "mode",
            "checkEmail"
          )
      ...
      >
        {(() => {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__geVjE)}
                label={"Email"}
                name={"email"}
              >
                <AntdInput
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField___5Cebj)}
                label={"Password"}
                name={"password"}
              >
                <AntdPassword
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__qsban,
                    {
                      [sty.textmode_signUp__qsban9WNk]: hasVariant(
                        $state,
                        "mode",
                        "signUp"
                      )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__o4X6G, {
            [sty.freeBoxmode_checkEmail__o4X6GHSqEm]: hasVariant(
              $state,
              "mode",
              "checkEmail"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__wl2F,
              {
                [sty.textmode_signUp__wl2F9WNk]: hasVariant(
                  $state,
                  "mode",
                  "signUp"
                )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__egPRr, {
          [sty.freeBoxmode_checkEmail__egPRrHSqEm]: hasVariant(
            $state,
            "mode",
            "checkEmail"
          )
      ...
      >
        <div
          className={classNames(
            ...
            sty.text__ebz92,
            {
              [sty.textmode_checkEmail__ebz92HSqEm]: hasVariant(
                $state,
                "mode",
                "checkEmail"
              )
