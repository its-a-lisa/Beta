...
import AuthButton from "../../AuthButton"; // plasmic-import: OJ4hkEA0eWqw/component
...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: KLWGUXPUlCOK/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: mOwGA2DVljZO/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: uSIDHmDKPAgC/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__fnXPj)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__afRBm)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__zEue8)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__zo3Ue)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__ijPz)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
