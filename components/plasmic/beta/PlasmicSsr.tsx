...
import PageLayout from "../../PageLayout"; // plasmic-import: KLWGUXPUlCOK/component
...
import sty from "./PlasmicSsr.module.css"; // plasmic-import: B4hPFrfybpsp/css
...
function PlasmicSsr__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    todos: usePlasmicDataOp(() => {
      return {
        sourceId: "62sT94zj3R9p3bk485hqph",
        opId: "cf5ad6e4-3657-43d4-96be-f6678cf29450",
        userArgs: {},
        cacheKey: `plasmic.$.cf5ad6e4-3657-43d4-96be-f6678cf29450.$.`,
        invalidatedKeys: null,
        roleId: "d7191a19-6d3a-47af-8905-f2767fcb7ce8"
      };
    })
  };
          ...
          >
            <ph.DataCtxReader>
              {$ctx => (
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__cbYwz)}
                  >
                    <h3
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__md4Ry)}
                  >
                    {(() => {
                      const child$Props = {
                              ...
                              $steps["tutorialdbCreate"] = true
                                ? (() => {
                                    const actionArgs = {
                                      dataOp: {
                                        sourceId: "62sT94zj3R9p3bk485hqph",
                                        opId: "1a48c38d-e6bc-4413-b3b2-5409f12ca458",
                                        userArgs: {
                                          variables: [
                                        ...
                                        roleId:
                                          "d7191a19-6d3a-47af-8905-f2767fcb7ce8"
                                      }
                                    };
                                    return (async ({
                                      dataOp,
...
function withPlasmicPageGuard<P extends object>(
  ...
  const PageGuard: React.FC<P> = props => (
    <p.PlasmicPageGuard
      minRole={"d7191a19-6d3a-47af-8905-f2767fcb7ce8"}
      appId={"b5CyNdwUApgg3rPkmHo66E"}
